...
class BaseHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		BaseFallbackFactory baseFallbackFactory = new BaseFallbackFactory(target);
		return (T) builder.target(target, baseFallbackFactory);
	}
